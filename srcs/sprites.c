...
/*   Updated: 2023/07/04 14:44:54 by cacarval         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (sprite == '1')
		mlx_put_image_to_window(game->mlx, game->win, game->sp[Wall].img, \
								x * SIZE, y * SIZE);
	else if (sprite == 'P')
		mlx_put_image_to_window(game->mlx, game->win, game->sp[Player].img, \
								x * SIZE, y * SIZE);
	else if (sprite == '0')
		mlx_put_image_to_window(game->mlx, game->win, game->sp[Spaces].img, \
								x * SIZE, y * SIZE);
	else if (sprite == 'E')
		mlx_put_image_to_window(game->mlx, game->win, game->sp[Exit].img, \
								x * SIZE, y * SIZE);
	else if (sprite == 'C')
		mlx_put_image_to_window(game->mlx, game->win, game->sp[Coin].img, \
								x * SIZE, y * SIZE);
}
